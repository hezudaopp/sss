...
require ('../includes/FullfillOrderNumbersInstall.php');

if (! isset ( $_POST ['password'] )) {
	?>

			<form method="POST" action="install-fullfill-order-number-data.php">
<table>
	<tr>
...
try {
	...
	DB::beginTransaction ();
	echo '向发车发船的订单号和订单子项号中添加数据<br />';
	new FullfillOrderNumbersInstall ( );
	echo '数据填充成功！';
	DB::commit ();
