...
require ('../includes/SummaryTableInstall.class.php');
require ('../includes/SummaryFileTableInstall.class.php');

if (! isset ( $_POST ['password'] )) {
	?>

			<form method="POST" action="install-summary.php">
<table>
	<tr>
...
echo '开始创建汇总表...<br />';
new SummaryFileTableInstall ( );
new SummaryTableInstall ( );
