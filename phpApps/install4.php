...
require ('../includes/Main2TableInstall.class.php');
require ('../includes/Fache2TableInstall.php');
require ('../includes/Fachuan2TableInstall.php');
...
echo '数据库创建成功<br />';
echo '开始创建用表...<br />';
new Main2TableInstall ( );
new Fache2TableInstall ( );
new Fachuan2TableInstall ( );
