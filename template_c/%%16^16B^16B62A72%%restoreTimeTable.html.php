<?php /* Smarty version 2.6.14, created on 2009-08-06 02:32:55
         compiled from restoreTimeTable.html */ ?>
...
span[class=exportBtn]:hover{
	...
	<div id="sbar" style="width:100%; padding: 0px 0px 4px 0px; border-bottom:1px solid #c9d7f1;">
			...
			| <span><a href="restoreTime.html">回滞留时间查询页面</a></span>
	</div>
	<?php endif; ?>
	
	<?php if ($this->_tpl_vars['interval']): ?>
		<!-- span class="exportBtn">
			<a href="exportRestoreTimeTable.php?fromDate=<?php echo $this->_tpl_vars['fromDate']; ?>
...
" title="点击进行导出结果">导出表格</a>
	...
	<table cellpadding="0" cellspacing="0">
			<tr>
				...
				<th style="min-width:4em">库存地</th>
				<th style="min-width:4em">目的地</th>
				<th style="width:6em">证书号</th>
				<th style="width:6em">结算批号</th>
				<th style="width:6em">发货批次</th>
				<th style="min-width:5em">停留时间</th>
				<th style="min-width:5em">入库日期</th>
				<th style="width:5em">入库车号</th>
				<th style="min-width:5em">出库日期</th>
				<th style="min-width: 5em">出库车号/船号</th>
			</tr>
		
			<?php unset($this->_sections['time']);
$this->_sections['time']['name'] = 'time';
$this->_sections['time']['loop'] = is_array($_loop=$this->_tpl_vars['interval']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
			<tr <?php if ($this->_tpl_vars['interval'][$this->_sections['time']['index']] == 0): ?> class="red" <?php else: ?> class="green" <?php endif; ?>>
				...
				<td><?php echo $this->_tpl_vars['interval'][$this->_sections['time']['index']]; ?>
</td>
				<td><?php echo $this->_tpl_vars['rukuDate'][$this->_sections['time']['index']]; ?>
</td>
				<td><?php echo $this->_tpl_vars['rukuNumber'][$this->_sections['time']['index']]; ?>
</td>
